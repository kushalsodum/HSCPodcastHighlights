...
MODEL_DIR = "rhapsody_model_transformer"
THRESHOLD = 0.3
...
def main():
    ...
    model.transformer.load_state_dict(torch.load(os.path.join(MODEL_DIR, "transformer.pt"), map_location=device))
    ...
    # Save results
    output_file = "prediction_results_transformer.json"
